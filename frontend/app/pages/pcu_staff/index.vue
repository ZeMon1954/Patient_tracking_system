          ...
          <div class="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-4">
            ...
            <div v-if="detailInfo.type === 'tracking'">
              ...
              <div v-else class="grid grid-cols-3 gap-3">
                ...
                >
                  <img :src="'http://localhost:3001/' + img.file_path.replace(/\\/g, '/')" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-200" />
...
const viewFullscreenImage = (filePath) => {
  const fullUrl = 'http://localhost:3001/' + filePath.replace(/\\/g, '/')
  Swal.fire({
    imageUrl: fullUrl,
