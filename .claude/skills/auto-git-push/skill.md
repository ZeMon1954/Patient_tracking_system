...
> ⚡ **AUTO-EXECUTE (CRITICAL)**: เมื่อ Trigger นี้ถูกเรียก **ห้าม pause, ห้าม confirm, ห้ามถามผู้ใช้ระหว่าง step** — ให้รัน Step 1 ก่อน แล้ว **ถ้าพบการเปลี่ยนแปลง** ให้รัน Step 2 → 3 → 4 → 5 ต่อทันทีในคำตอบเดียวกัน
...
**⚠️ Decision (ทำทันทีหลัง Step 1 เสร็จ — ไม่ต้องรอ input จากผู้ใช้):**
- ถ้า **มีไฟล์ที่เปลี่ยนแปลง** → รัน Step 2, 3, 4, 5 ต่อเลย
- ถ้า **ไม่มีอะไรเปลี่ยน** ("nothing to commit") → แจ้งผู้ใช้ว่า repo เป็นปัจจุบันแล้ว จบ
